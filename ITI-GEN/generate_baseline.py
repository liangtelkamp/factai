...
def main():
    ...
    if opt.laion400m:
        ...
        opt.config = "/home/scur1031/stable-diffusion/configs/latent-diffusion/txt2img-1p4B-eval.yaml"
        opt.ckpt = "/home/scur1031/stable-diffusion/models/ldm/text2img-large/model.ckpt"
        opt.outdir = "/home/scur1031/stable-diffusion/outputs/txt2img-samples-laion400m"
                    ...
                    for prompts in tqdm(data, desc="data"):
                        ...
                        if not opt.skip_save:
                            for x_sample in x_checked_image_torch:
                                ...
                                img.save(os.path.join(sample_path, f"{prompt}_{base_count:05}.png")) # Included the prompt in the filename
                                base_count += 1
